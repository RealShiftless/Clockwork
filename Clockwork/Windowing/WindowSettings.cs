...
{
    /// <summary>
    /// Carbon copy of OpenTK's NativeWindow settings
    /// </summary>
    internal class WindowSettings
    {
        /// <summary>
        /// Gets the default settings for a <see cref="WindowSettings"/>.
        /// </summary>
        public static readonly WindowSettings Default = new WindowSettings();
        ...
        /// </summary>
        public VSyncMode VSyncMode { get; set; } = VSyncMode.Off;
    }
}
